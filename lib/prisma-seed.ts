...
export async function runFullSeed(prisma: PrismaClient) {
  ...
  const jobs = [
    {
      ...
      description:
        'Als Pflegefachkraft bei IMPULS übernehmen Sie die eigenverantwortliche Durchführung der Grund- und Behandlungspflege bei unseren Klientinnen und Klienten. Sie arbeiten in einem wertschätzenden Team, das Menschlichkeit und professionelle Pflege vereint.\n\nIhre Aufgaben:\n- Durchführung der Grund- und Behandlungspflege\n- Pflegedokumentation und -planung\n- Beratung von Klienten und Angehörigen\n- Zusammenarbeit mit Ärzten und Therapeuten\n- Medikamentenmanagement',
      requirements:
    ...
    },
    {
      ...
      shortIntro:
        'Unterstützen Sie unser Team in der täglichen Pflege und Betreuung – auch als Quereinsteiger mit Herz willkommen.',
      description:
        'Als Pflegehilfskraft unterstützen Sie unser Pflegeteam bei der täglichen Versorgung unserer Klientinnen und Klienten. Sie helfen bei der Grundpflege und tragen zu einem würdevollen Alltag bei.\n\nIhre Aufgaben:\n- Unterstützung bei der Grundpflege\n- Hilfe bei der Mobilisation\n- Begleitung im Alltag\n- Dokumentation der durchgeführten Maßnahmen',
      requirements:
        '- Pflegebasiskurs oder Bereitschaft zur Qualifizierung\n- Führerschein Klasse B\n- Zuverlässigkeit und Einfühlungsvermögen\n- Freude am Umgang mit Menschen',
      benefits:
    ...
    },
    {
      ...
      workload: 'Teilzeit',
      shortIntro:
        'Schenken Sie Menschen wertvolle Zeit – durch aktivierende Betreuung und einfühlsame Begleitung im Alltag.',
      description:
        'Als Betreuungskraft gestalten Sie den Alltag unserer Klientinnen und Klienten aktiv und liebevoll mit. Sie bieten Beschäftigung, Gesellschaft und Unterstützung.\n\nIhre Aufgaben:\n- Aktivierende Betreuung und Beschäftigung\n- Begleitung bei Spaziergängen und Terminen\n- Gesellschaft und Gesprächsangebote\n- Unterstützung im häuslichen Umfeld',
      requirements:
        '- Qualifikation nach §43b/§53b SGB XI wünschenswert\n- Einfühlungsvermögen und Geduld\n- Freude an der Arbeit mit Menschen\n- Zuverlässigkeit',
      benefits:
    ...
    },
    {
      ...
      shortIntro:
        'Sorgen Sie für ein gepflegtes Zuhause unserer Klienten – mit Sorgfalt, Zuverlässigkeit und einem freundlichen Wesen.',
      description:
        'Als Hauswirtschaftskraft unterstützen Sie unsere Klientinnen und Klienten bei der Bewältigung des Haushalts und tragen so zu einem würdevollen Leben im eigenen Zuhause bei.\n\nIhre Aufgaben:\n- Reinigung und Pflege der Wohnung\n- Wäschepflege\n- Einkäufe und Besorgungen\n- Zubereitung einfacher Mahlzeiten',
      requirements:
  ...
  const settings = [
    ...
    { key: 'org_address', value: JSON.stringify('Massener Str. 147, 59423 Unna') },
    { key: 'org_phone', value: JSON.stringify('02303 2920589') },
